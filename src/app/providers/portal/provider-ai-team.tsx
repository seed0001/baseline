...
export function ProviderAiTeam({
  ...
  return (
    <div className="space-y-3">
        ...
        <div className="mt-3 grid grid-cols-2 gap-2 lg:grid-cols-4">
          {personas.map((item) => (
            <button
              ...
              className={`rounded-lg border p-2.5 text-left transition ${selectedKey === item.key ? "border-teal-600 bg-teal-50 ring-1 ring-teal-600" : "border-slate-200 hover:border-slate-300"}`}
            >
      ...
      <section className="overflow-hidden rounded-lg bg-gradient-to-br from-teal-900 via-teal-800 to-cyan-700 text-white shadow-md">
        ...
        <div className="max-h-[32rem] min-h-72 space-y-2.5 overflow-y-auto bg-slate-50 p-3 sm:p-4">
          {messages.length === 0 && (
