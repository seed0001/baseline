...
export const categories: ServiceCategory[] = [
  { id: "plumbing", name: "Plumbing", description: "Fixtures, water heaters, leaks, and pipe work", serviceCount: 14 },
  { id: "electrical", name: "Electrical", description: "Fans, panels, outlets, and lighting", serviceCount: 12 },
  { id: "remodeling", name: "Remodeling", description: "Bathrooms, kitchens, and full renovations", serviceCount: 9 },
  { id: "construction", name: "Commercial Construction", description: "Office build-outs, tenant improvements, and multi-phase commercial jobs", serviceCount: 6 },
  { id: "software", name: "Software & App Development", description: "Custom web apps, mobile apps, e-commerce, and system integrations", serviceCount: 8 },
  { id: "creative", name: "Creative & Design", description: "Branding, photography, video, and design work", serviceCount: 9 },
  { id: "marketing", name: "Marketing & Growth", description: "SEO, paid ads, social, and content programs", serviceCount: 7 },
  { id: "professional", name: "Professional Services", description: "Bookkeeping, tax prep, filings, and consulting", serviceCount: 8 },
  { id: "events", name: "Events & Catering", description: "Corporate events, catering, and AV production", serviceCount: 6 },
  { id: "automotive", name: "Automotive", description: "Brakes, batteries, and routine maintenance", serviceCount: 8 },
  { id: "lawn", name: "Lawn & Property", description: "Mowing, pressure washing, and exterior care", serviceCount: 11 },
  { id: "technology", name: "Technology", description: "Networking, smart home, and device setup", serviceCount: 7 },
  { id: "cleaning", name: "Cleaning", description: "Deep cleans, move-out cleans, and recurring service", serviceCount: 6 },
  { id: "moving", name: "Moving & Hauling", description: "Local moves, furniture, and junk removal", serviceCount: 5 },
